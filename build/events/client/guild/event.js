    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (interaction.customId.startsWith("buttonn_")) {
                ...
                if (query) {
                    if (((_k = query.commands) === null || _k === void 0 ? void 0 : _k.length) === 0) {
                        return yield interaction.update({
                            embeds: [
                                yield (0, mainEmbed_1.default)(`تاكد من اختيار لعبه واحده على الاقل! | ${emojis_1.default.false}`),
                            ],
                            components: [],
                        });
                    }
                ...
                yield interaction.update({
                    embeds: [
                        yield (0, mainEmbed_1.default)(`سيتم تفعيل اللعبه بإذن الله بعد قليل, أستمتع, ${emojis_1.default.true}`),
                    ],
                    components: [],
                });
                if (query === null || query === void 0 ? void 0 : query.commands) {
                ...
                yield interaction.update({
                    embeds: [yield (0, mainEmbed_1.default)(`تم بنجاح تنفيذ الأمر | ${emojis_1.default.true}`)],
                    components: [],
                });
            }
        });
