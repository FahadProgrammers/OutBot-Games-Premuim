...
class اكس extends MessageCreate_1.default {
    ...
    execute(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!member) {
                const embed = (0, warnembed_1.default)(`${emojis_1.default.false} | تأكد من منشن عضو او كتابه كلمه بوت!`);
                yield message.reply({
                    embeds: [embed],
                });
                return;
            }
            if (message.author.id === (member === null || member === void 0 ? void 0 : member.id)) {
                const embed = (0, warnembed_1.default)(`${emojis_1.default.false} | تأكد من عدم منشن نفسك او بوت!`);
                yield message.reply({
                    embeds: [embed],
                });
                return;
            }
            const embed = (0, mainEmbed_1.default)(`<@${member === null || member === void 0 ? void 0 : member.id}> | هل تريد العب ضد <@${(_c = message.author) === null || _c === void 0 ? void 0 : _c.id}>`);
            ...
            if (!(member === null || member === void 0 ? void 0 : member.bot)) {
                if (message.channel instanceof discord_js_1.TextChannel) {
                    ...
                    if (MessagetargetUserInteraction.customId === `true-${message.author.id}`) {
                        if (message.guild) {
                            const embeddone = (0, BaseEmbed_1.default)(message.guild, {
                        ...
                        const embedwarn = (0, warnembed_1.default)(`${emojis_1.default.false} | تم رفض قبول اللعبه`);
                        yield sendInteraction.edit({
                            embeds: [embedwarn],
                            components: [],
                        });
            ...
            function startGame() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const emb = (0, mainEmbed_1.default)(`حان دور <@${member === null || member === void 0 ? void 0 : member.id}> ل العب!`);
