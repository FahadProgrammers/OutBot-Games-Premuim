...
class رتب extends MessageCreate_1.default {
    constructor(client) {
        super(client, {
            name: "رتب",
    ...
    execute(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const randomKey = words_json_1.default.words[Math.floor(Math.random() * words_json_1.default.words.length)];
            ...
            let status = false;
            try {
                yield (0, MessageCollecter_1.default)(messageFetch, randomKeyWithrtb, randomKey, time_1);
            }
            catch (err) {
