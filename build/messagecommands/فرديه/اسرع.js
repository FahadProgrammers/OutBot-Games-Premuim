    ...
    execute(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, canvas_1.loadImage)(filePath)
                ...
                canvas_1.default.registerFont(path_1.default.resolve("src/utils/assets/Fonts", "BalooBhaijaan2-VariableFont_wght.ttf"), {
                    family: "ImageFontt",
                });
            ...
            let status = false;
            try {
                yield (0, MessageCollecter_1.default)(messageFetch, randomword_2_2, randomword_2_2, time_1);
            }
            catch (err) {
