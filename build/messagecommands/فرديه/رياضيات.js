...
const randomNum_1 = __importDefault(require("../../utils/functions/randomNum"));
...
class رياضيات extends MessageCreate_1.default {
    constructor(client) {
        super(client, {
            name: "رياضيات",
    ...
    execute(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const keys = (0, randomNum_1.default)();
            ...
            let status = false;
            try {
                yield (0, MessageCollecter_1.default)(messageFetch, `${num1}${key.replace("*", "X")}${num2}`, answer.toString(), time_1);
            }
            catch (err) {
