...
class اسرع extends MessageCreate_1.default {
    ...
    execute(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const wordsss = words_json_1.default.words;
            const randomword_2_2 = wordsss[Math.floor(Math.random() * words_json_1.default.words.length)];
            const applied = yield (0, google_translate_1.default)(randomword_2_2, { to: "en" });
            ...
            yield (0, canvas_1.loadImage)(filePath)
                ...
                ctx.fillStyle = "White";
                ctx.fillText("✧ ترجم الكلمه قبل إنتهاء الوقت ✧", 165, 180);
                //Time
                ctx.font = "25px ImageFont";
                ctx.fillStyle = "White";
            ...
            let status = false;
            try {
                yield (0, MessageCollecter_1.default)(messageFetch, randomword_2_2, applied.text.toLowerCase(), time_1);
            }
            catch (err) {
